	...
	<div class="twitter__container">
		...
		<div class="twitter__contents scroll">
			...
			<div class="twitter__block">
				<figure>
					<img src="/opt/tomcat/apache-tomcat-9.0.41/webapps/Combined-test/user-img/<%=post.getUser_img()%>" />
				</figure>
				<div class="twitter__block-text">
					...
					<div class="text">
						<%=post.getContents() %><br>
						<img src="/opt/tomcat/apache-tomcat-9.0.41/webapps/Combined-test/post-img/<%=post.getImg()%>" width="325" height="270"/>
					</div>
				</div>
			</div>
			<%} %>
