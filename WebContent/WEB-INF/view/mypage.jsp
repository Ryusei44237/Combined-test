										...
										<div class="col-3" style="width: 160px;">
											<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
												...
												<a class="nav-link " id="v-pills-home-tab" data-toggle="pill"
													...
													aria-selected="true" style="width: 155px;">ガイドライン</a> <a
				...
				<body style="background:#fcfcfc;">
					...
					<section class="header">
						<div class="header_items">
							...
							<div id="h_item2">
								<div id="form_group">
									<form action="/sotuken-project/tourokuServlet" method="get"><button type="submit"
											class="clear-decoration">登録</button></form>
									<form action="/sotuken-project/TestServlet" method="get"><button type="submit"
											class="clear-decoration">ログイン</button></form>
									<form action="/sotuken-project/MyPageServlet" method="get"><input type="hidden"
											name="account_id" value=<%=request.getAttribute("accountid")%>><button
											type="submit" class="clear-decoration" name="name"
											value=<%=request.getAttribute("getname") %>>マイページ</button></form>
								</div>
							</div>
							<!-- タイトル -->
							<div id="h_item3">
							...
							<div id="h_item4">
								...
								<div id="setting">
									<button type="button" class="btn btn-primary" data-toggle="modal"
										data-target=".bd-example-modal-sm"><i class="fas fa-cog"></i></button>
								</div>
							</div>
						</div>
					</section>
  ...
  -->
					<div class="home-page">
						...
						<ul class="nav nav-tabs" id="myTab" role="tablist">
							<li class="nav-item"><a class="nav-link active blue" id="home-tab" data-toggle="tab"
									href="#home" role="tab" aria-controls="home" aria-selected="true">過去投稿</a></li>
							<li class="nav-item"><a class="nav-link blue" id="profile-tab" data-toggle="tab"
									href="#profile" role="tab" aria-controls="profile" aria-selected="false">画像一覧</a>
							</li>
							<li class="nav-item"><a class="nav-link blue" id="contact-tab" data-toggle="tab"
									href="#contact" role="tab" aria-controls="contact" aria-selected="false">アカウント管理</a>
							</li>
						</ul>
												...
												<div class="form-row">
													<div class="col-md-5 mb-3">
														...
														<input type="text" class="form-control" id="validationCustom01"
															value=<%=request.getAttribute("id")%> name="userid"
														required>
													...
													<div class="col-md-5 mb-3">
														...
														<input type="text" class="form-control" id="validationCustom02"
															value=<%=request.getAttribute("name")%> name="lastname"
														required>
														<div class="valid-feedback">
												...
												<div class="form-row">
													<div class="col-md-5 mb-3">
														...
														<input type="text" class="form-control" id="validationCustom03"
															value=<%=request.getAttribute("tell")%> name="tell"
														required>
												...
												<div class="form-row">
													<div class="col-md-5 mb-3">
														...
														<input type="password" class="form-control"
															id="validationCustom04" placeholder="パスワード" name="password"
															required>
														<div class="invalid-feedback">
														</div>
													</div>
													<div class="col-md-5 mb-3">
														...
														<input type="password" class="form-control"
															id="validationCustom05" placeholder="パスワードの再入力をお願いします"
